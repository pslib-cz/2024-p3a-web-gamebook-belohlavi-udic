    ...
    public class GameService : IGameService
    {
        ...
        public async Task<Player> CreateNewGame(string userId)
        {
            ...
            else
            {
                ...
                // Find the starting room (assuming room with ID 1 is the start)
                ...
                var gameState = new GameState
                {
                    // Player ID is not available until the player is saved and an ID is generated by the database.
