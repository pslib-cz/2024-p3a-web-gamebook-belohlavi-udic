...
namespace Gamebook.Server.Migrations
{
    ...
    [Migration("20241210210621_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gamebook.Server.Models.Action", b =>
                {
            ...
            modelBuilder.Entity("Gamebook.Server.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "720260b0-2e87-4a40-bce3-813ccbf56f81",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "9ac98d65-4c8f-4617-a84a-a79a58724a4b",
                            Name = "Author",
            ...
            modelBuilder.Entity("Gamebook.Server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7aa16c3a-247e-45b6-9693-531afe42c7b9",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9ecafede-d081-40d8-8d26-907df6dd691c",
                            Email = "admin@localhost.test",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@LOCALHOST.TEST",
                            NormalizedUserName = "ADMIN@LOCALHOST.TEST",
                            PasswordHash = "AQAAAAIAAYagAAAAEDcyKhaUekRFFk2dZDv9ds5I5b8ICT+nFxDQbWC0CN5DjAnlecB5/2IshqY8OlLDyg==",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = "720260b0-2e87-4a40-bce3-813ccbf56f81",
                            UserId = "7aa16c3a-247e-45b6-9693-531afe42c7b9"
                        },
                        new
                        {
                            RoleId = "9ac98d65-4c8f-4617-a84a-a79a58724a4b",
                            UserId = "7aa16c3a-247e-45b6-9693-531afe42c7b9"
                        });
                });
            ...
            modelBuilder.Entity("Gamebook.Server.Models.Action", b =>
                {
                    ...
                    b.HasOne("Gamebook.Server.Models.Room", "TargetRoom")
                        .WithMany()
